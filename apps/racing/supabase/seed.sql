...
insert into public.seasons (id, name, slug, year, status, start_date, end_date) values
  ('10000000-0000-4000-8000-000000000001', 'Season 1', 'season-1', 2027, 'active', '2026-10-01', '2027-03-31');

insert into public.teams (id, name, short_name, code, country, country_code, primary_color, secondary_color) values
...
insert into public.drivers (id, display_name, nationality, country_code, racing_number, status) values
...
insert into public.season_driver_entries (season_id, driver_id, team_id, racing_number, role, status) values
...
insert into public.circuits (id, name, slug, short_name, country, country_code, city, length_km, default_laps) values
...
insert into public.grand_prix_events (season_id, circuit_id, name, slug, round_number, scheduled_date, status) values
