...
select throws_ok($$insert into public.grand_prix_events (season_id, circuit_id, name, slug, round_number, scheduled_date) values ('ffffffff-ffff-4fff-8fff-ffffffffffff', '40000000-0000-4000-8000-000000000001', 'Unknown season', 'unknown-season', 90, '2027-01-01')$$, '23503', null, 'un Gran Premio requiere una temporada existente');
select throws_ok($$insert into public.grand_prix_events (season_id, circuit_id, name, slug, round_number, scheduled_date) values ('10000000-0000-4000-8000-000000000001', 'ffffffff-ffff-4fff-8fff-ffffffffffff', 'Unknown circuit', 'unknown-circuit', 91, '2027-01-01')$$, '23503', null, 'un Gran Premio requiere un circuito existente');
...
select throws_ok($$insert into public.grand_prix_events (season_id, circuit_id, name, slug, round_number, scheduled_date, race_laps) values ('10000000-0000-4000-8000-000000000001', '40000000-0000-4000-8000-000000000001', 'Too few laps', 'too-few-laps', 92, '2027-01-01', 3)$$, '23514', null, 'el override rechaza menos de cuatro vueltas');
select throws_ok($$insert into public.grand_prix_events (season_id, circuit_id, name, slug, round_number, scheduled_date, race_laps) values ('10000000-0000-4000-8000-000000000001', '40000000-0000-4000-8000-000000000001', 'Too many laps', 'too-many-laps', 93, '2027-01-01', 9)$$, '23514', null, 'el override rechaza más de ocho vueltas');
...
select lives_ok($$insert into public.grand_prix_events (season_id, circuit_id, name, slug, round_number, scheduled_date, race_laps) values ('10000000-0000-4000-8000-000000000001', '40000000-0000-4000-8000-000000000001', 'Override valid', 'override-valid', 94, '2027-01-02', 8)$$, 'acepta un override de vueltas válido');
select is((select effective_race_laps from public.grand_prix_calendar where slug = 'override-valid'), 8::smallint, 'el calendario aplica el override de vueltas');

select throws_ok($$insert into public.season_driver_entries (season_id, driver_id, team_id) values ('ffffffff-ffff-4fff-8fff-ffffffffffff', '30000000-0000-4000-8000-000000000002', '20000000-0000-4000-8000-000000000001')$$, '23503', null, 'una participación requiere una temporada existente');
select throws_ok($$insert into public.season_driver_entries (season_id, driver_id, team_id) values ('12000000-0000-4000-8000-000000000001', '30000000-0000-4000-8000-000000000002', 'ffffffff-ffff-4fff-8fff-ffffffffffff')$$, '23503', null, 'una participación requiere una escudería existente');
select lives_ok($$insert into public.season_driver_entries (season_id, driver_id, team_id, start_date, end_date) values ('12000000-0000-4000-8000-000000000001', '30000000-0000-4000-8000-000000000002', '20000000-0000-4000-8000-000000000001', '2027-01-01', '2027-01-31'), ('12000000-0000-4000-8000-000000000001', '30000000-0000-4000-8000-000000000002', '20000000-0000-4000-8000-000000000002', '2027-02-01', '2027-02-28')$$, 'permite cambios de escudería con períodos no solapados');
...
select throws_ok($$insert into public.season_driver_entries (season_id, driver_id, team_id, start_date, end_date) values ('12000000-0000-4000-8000-000000000001', '30000000-0000-4000-8000-000000000003', '20000000-0000-4000-8000-000000000002', '2027-03-01', '2027-01-01')$$, '23514', null, 'rechaza fechas de participación invertidas');
